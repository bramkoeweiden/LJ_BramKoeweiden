...
myeff <- includeEffects(myeff, inPop, outAct, transTies )
...
myAlgorithm <- sienaAlgorithmCreate(projname = "soc_init", n3 = 200, firstg = 2)
ansM1 <- siena07(myAlgorithm, data = mydata, effects = myeff, returnDeps = TRUE, batch = TRUE, nbrNodes = 6)
# if necessary estimate again!  ansM1 <- siena07(myAlgorithm, data = mydata, effects = myeff,
# prevAns = ansM1, returnDeps=TRUE)
ansM1
